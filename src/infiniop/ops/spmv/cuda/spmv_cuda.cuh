#ifndef __SPMV_CUDA_API_H__
#define __SPMV_CUDA_API_H__
...
public:
    Descriptor(const SpMVInfo &info, Opaque *opaque, infiniDevice_t device, int32_t device_id)
        : operator_base{device, device_id}, _info(info), _opaque(opaque) {}
    ~Descriptor();
