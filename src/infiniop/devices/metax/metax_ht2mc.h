...
#define hcsparseHandle_t mcsparseHandle_t
#define hcsparseStatus_t mcsparseStatus_t
#define hcsparseCreate mcsparseCreate
...
#define hcsparseSpVV mcsparseSpVV
#define hcsparseSpMV_bufferSize mcsparseSpMV_bufferSize
#define hcsparseSpMV mcsparseSpMV
#define hcsparseSpMatDescr_t mcsparseSpMatDescr_t
#define hcsparseSpVecDescr_t mcsparseSpVecDescr_t
#define hcsparseDnMatDescr_t mcsparseDnMatDescr_t
#define hcsparseDnVecDescr_t mcsparseDnVecDescr_t
#define hcsparseOperation_t mcsparseOperation_t
...
#define HCSPARSE_ORDER_ROW MCSPARSE_ORDER_ROW
#define HCSPARSE_ORDER_COL MCSPARSE_ORDER_COL
